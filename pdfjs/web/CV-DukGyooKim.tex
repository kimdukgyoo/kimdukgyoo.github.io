...
\item A Theory of FAQs (with Yeochang Yoon)
\item Multilateral Bargaining with Proposer Selection Contests (with Sang-Hyun Kim)
\item Positional Concern and Low Demand for Redistribution of the Poor
...
\textbf{2018 (*=scheduled)}: Royal Economic Society Conference, HeiKaMax Workshop*, Social Choice and Welfare Conference*, Asian Meeting of the Econometric Society*, Foundations of Risk and Uncertainty Conference*, Economic Science Association World Meeting*, International Conference on Game Theory*\\
