...
\item Sharing the Burden of Endogenous Negative Externalities (with Andrzej Baranski-Madrigal), accepted with minor revision at \emph{Ecological Economics}
\item Viable Nash Equilibria: An Experiment (with Daehong Min and John Wooders), accepted at \emph{Economic Theory}
...
%\textbf{2024}: Korean Economic Association Conference, KAIST, Asia-Pacific Economic Science Association Meeting, M-BEES, ..
